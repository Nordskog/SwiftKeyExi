...
{
	//Ref strings_preferences.xml

	//Settings
	public static final String pref_dictionary_toggle_key = "pref_dictionary_toggle";
	//public static final String pref_emoji_toggle_key = "pref_emoji_toggle";
	//public static final String pref_longpress_key_toggle_key = "pref_longpress_key_toggle";
	//public static final String pref_more_suggestions_toggle_key = "pref_more_suggestions_toggle";
	...
	//public static final String pref_space_swipe_modifier_key = "pref_space_swipe_modifier_key";
	...
	public static final String pref_disable_prediction_autospace_key = "pref_disable_prediction_autospace";
