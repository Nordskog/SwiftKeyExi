...
public class SimpleGestureFrameLayout extends FrameLayout implements GestureDetector.OnGestureListener
{
	...
	public SimpleGestureFrameLayout(@NonNull Context context)
	{
		super(context);
		init(context);
	}

	public SimpleGestureFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs)
	{
		super(context, attrs);
		init(context);
	}

	public SimpleGestureFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr)
	{
		super(context, attrs, defStyleAttr);
		init(context);
	}

	public SimpleGestureFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes)
	{
