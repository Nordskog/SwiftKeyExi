...
public class EmojiPanelTemplates
{
	...
	private static String LOGTAG = ExiModule.getLogTag(EmojiPanelTemplates.class);
	...
	static
	{
		...
		//Stock Emoji Smiley
		{
			...
			EMOJI_PANEL_TEMPLATES.add( getEmojiPanel(newStrings, 1, "☺", "☺", 0, true) );
		}
		...
		//Reddit emoticons
		{
			String[] newStrings = new String[]{
					...
					"(҂◡_◡)",
					"ƪ(ړײ)‎ƪ​", };
			EMOJI_PANEL_TEMPLATES.add( getEmojiPanel( newStrings, 4, "ಠ_ಠ", "ಠ_ಠ", 0,false) );
		}
...

		{
			String[] newStrings = new String[]{
					...
					"☜(ﾟヮﾟ☜)",
					"☜(⌒▽⌒)☞", };
			EMOJI_PANEL_TEMPLATES.add( getEmojiPanel(newStrings, 4, "( ・ω・)", "( ・ω・)", 0,false) );
		}
	...
	private static DB_EmojiPanelItem getEmojiPanel(String[] strings, int colWidth, String icon, String caption, int index, boolean emojiOnly)
	{
